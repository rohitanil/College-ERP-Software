        ...
        <ul class="sf-menu" id="nav">
          ...
          <li><a href="#">CONTROL</a>
            ...
            <li><a href="#">Teacher</a>
              ...
              <li class="selected"><a href="admin_deleteteacherpage.php">Delete Teacher</a>
    ...
    <div id="site_content">
      ...
      <div class="content">
        ...
        <form action="deleteteacher.php" method="post">
          ...
          <p><span><strong>TEACHER</strong></span><select name="name">
        ...
        else
       {
        ...
        $query="SELECT username FROM teacher WHERE name !='$user'";
       ...
       ?>
            ...
            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="delete" value="DELETE" /></p>
          </div>
        </form>
      </div>
    </div>
