      ...
      <nav>
        <ul class="sf-menu" id="nav">
          ...
          <li><a href="#">TEACHER'S DIARY</a>
            <ul>
              <li class="selected"><a href="#">Assignment</a>
              <ul>
                <li class="selected"><a href="#">Set</a></li>
              </ul>
              </li>
      ...
      <div class="content">
        ...
        <form action="assignment.php" method="post">
          <div class="form_settings">
            ...
            <p><span><strong>ASSIGNMENT ID</strong></span><select name="ass_id">
 ...
 elseif($dept == "Tb")
 {
  ...
  $dbselected2='t_subjectlist';
       ...
       ?>
            ...
            <p><span><strong>SUBMISSION DATE</strong></span><input type="date" name="submit_date"/></p>
            <p><span><strong>ASSIGNMENT</strong></span><textarea rows="8" cols="50" name="assign_data"></textarea></p>
