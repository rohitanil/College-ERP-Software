  ...
  <div id="main">
        ...
        <ul class="sf-menu" id="nav">
          ...
          <li><a href="#">CONTROL</a>
            ...
            <li><a href="#">Department</a>
              ...
              <li class="selected"><a href="#">View</a>
                <ul>
    ...
    <div id="site_content">
      <div class="gallery">
       ...
       <div id="form">
      <h2>SUBJECT LIST</h2>
      <form action="viewsubject.php" method="post"><!-- Add form action and other stuff -->
       ...
       <h2>TEACHER LIST</h2>
      <form action="viewsubjectteacher.php" method="post"><!-- Add form action and other stuff -->
        <div class="form_settings">
        <p><strong><span>COURSE</span></strong>
            <select id="id" name="course">
                  <li><option value="btech">BTECH</option></li>
