  ...
  <div id="main">
        ...
        <ul class="sf-menu" id="nav">
          ...
          <li><a href="#">CONTROL</a>
            ...
            <li><a href="#">Department</a>
              ...
              <ul>
              <li class="selected"><a href="timetable.php">Set</a></li>
    ...
    <div id="site_content">
      <div class="gallery">
       ...
       <div id="form">
      <h2>SET TIMETABLE</h2>
      <form action="settimetable.php" method="post"><!-- Add form action and other stuff -->
      	...
      	<p><strong><span>COURSE</span></strong>
      		...
      		<p><span><strong>PERIOD 1</strong></span><input type="text" name="sub1" value="" /></p> 
      		<p><span><strong>PERIOD 2</strong></span><input type="text" name="sub2" value="" /></p> 
      		<p><span><strong>PERIOD 3</strong></span><input type="text" name="sub3" value="" /></p> 
      		<p><span><strong>PERIOD 4</strong></span><input type="text" name="sub4" value="" /></p> 
      		<p><span><strong>PERIOD 5</strong></span><input type="text" name="sub5" value="" /></p> 
      		<p><span><strong>PERIOD 6</strong></span><input type="text" name="sub6" value="" /></p> 
